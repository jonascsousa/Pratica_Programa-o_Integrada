			...
			<div class="row">
				<div class="form-group col-md-12">
					<label for="nome">Nome</label> <input type="text"
						...
						placeholder="Nome do Pais" value="${pais.nome}">
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-6">
					<label for="populacao">População</label> <input type="number"
						...
						placeholder="População do Pais" value="${pais.populacao}">
				</div>

				<div class="form-group col-md-6">
					<label for="area">E-Mail</label> <input type="number"
						class="form-control" name="area" id="area" required
						placeholder="Area do Pais" value="${pais.area}">
				</div>
			</div>
			<hr />
